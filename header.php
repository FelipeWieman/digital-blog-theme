					...
					<a href="/">
						<div class="logo">
							<?php if (get_theme_mod('header_logo')): ?>
								...
								<?php if (pathinfo($header_logo, PATHINFO_EXTENSION) === 'svg'): ?>
									<img src="<?php echo esc_url($header_logo); ?>"
										alt="<?php echo esc_attr(get_bloginfo('name')); ?>" class="svg-logo">
								<?php else: ?>
									<img src="<?php echo esc_url($header_logo); ?>"
							...
							<?php endif; ?>
							<span><?php echo esc_html(get_theme_mod('header_text', 'FOR DIGITAL NERDS')); ?></span>
						</div>
					</a>
				</div>
