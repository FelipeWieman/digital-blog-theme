	...
	<div class="wrapper">
		<header class="header ">
						...
						<g id="a" clip-path="url(#b)">
							<g transform="translate(0 0.01)">
								<path
									...
									transform="translate(-284.178 -398.619)" fill="#fff" />
								<path
									...
									transform="translate(-306.528 -417.906)" fill="#fff" />
								<path fill="#fff"
								...
								<path
									...
									transform="translate(-898.158 -417.88)" fill="#fff" />
								<path
			...
			<div class="header-right-block ">
				<div class="nav_menu">
					<div><a href="/">Startesite</a></div>
					<div><a href="/blog">Blog</a></div>
					<div><a href="/about">About us</a></div>
					<div><a href="/tech-stack">Tech stack</a></div>
					<div><a href="/jobs">Jobs</a></div>
				</div>
				<div class="header_search">
					<svg class="w-6" enable-background="new 0 0 32 32" id="Glyph" version="1.1" viewBox="0 0 32 32"
			...
			<div class="header-right-block-mobile">
				...
				<div class="mobile-menu">
					<span class="mb-[1rem]">FOR DIGITAL NERDS</span>
					<div><a href="/">Startesite</a></div>
					<div><a href="/blog">Blog</a></div>
					<div><a href="/about">About us</a></div>
					<div><a href="/tech-stack">Tech stack</a></div>
