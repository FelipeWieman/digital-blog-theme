		...
		<div class="related-posts-container">
			<?php if ($prev_post): ?>
				<div class="card">
					...
					<div class="card-body">
						<div class="card-top">
							<h2><a href="<?php echo get_permalink($prev_post->ID); ?>"><?php echo $prev_post->post_title; ?></a>
							</h2>
			...
			<?php if ($next_post): ?>
				<div class="card">
					...
					<div class="card-body">
						<div class="card-top">
							<h2><a href="<?php echo get_permalink($next_post->ID); ?>"><?php echo $next_post->post_title; ?></a>
							</h2>
